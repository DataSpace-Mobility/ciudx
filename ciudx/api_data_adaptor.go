...
// Deleteadaptor - Delete adaptor
func Deleteadaptor(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{})
}

// Getadaptordetails - Retrieve adapter details
func Getadaptordetails(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{})
}

// Registeradapter - Register adapter
func Registeradapter(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{})
}
