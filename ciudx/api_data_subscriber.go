...
// Appendstreamingsubscription - Append subscription
func Appendstreamingsubscription(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{})
}

// Createastreamingsubscription - Create subscription
func Createastreamingsubscription(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{})
}

// Deleteasubscription - Delete subscription
func Deleteasubscription(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{})
}

// Getstreamingsubscription - Retrieve subscription details
func Getstreamingsubscription(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{})
}

// Updatestreamingsubscription - Update subscription
func Updatestreamingsubscription(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{})
}
